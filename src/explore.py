        ...
        for batchi, (
            ...
            for si in range(imgs.shape[0]):
                ...
                for imgi, img in enumerate(imgs[si]):
                    ...
                    plot_pts = post_rots[si, imgi].matmul(ego_pts) + post_trans[
                        si, imgi
                    ].unsqueeze(1)
                    ...
                    plt.sca(final_ax)
                    plt.plot(
                        img_pts[si, imgi, :, :, :, 0].view(-1),
                        img_pts[si, imgi, :, :, :, 1].view(-1),
                        ".",
